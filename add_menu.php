...
<head>
    ...
    <style>
        ...
        .form-container input:focus, .form-container select:focus {
            outline: none; border-color: var(--chalk-yellow); background-color: rgba(255,255,255,0.05);
        }
        .form-container select option { background-color: var(--board); color: var(--chalk); }
        .form-container button {
            background-color: transparent; color: var(--chalk-yellow); border: 2px dashed var(--chalk-yellow);
            padding: 12px; font-family: 'Charmonman', cursive; font-size: 24px; width: 100%; cursor: pointer; transition: 0.2s;
        }
        .form-container button:hover { background-color: var(--chalk-yellow); color: var(--board); }
...
<body>
    ...
    <div class="content">
        <h1 class="page-title">เพิ่มเมนูใหม่</h1>
        
        <div class="form-container">
            <form action="action/insert_menu.php" method="post">
                <label for="">รหัสเมนู</label>
                <input type="text" name="menu_id" autocomplete="off" required>

                <label for="">ชื่อเมนู</label>
                <input type="text" name="menu_name" autocomplete="off" required>

                <label for="">ราคา</label>
                <input type="text" name="menu_price" autocomplete="off" required>

                <label for="">URL ภาพ</label>
                <input type="text" name="menu_image" autocomplete="off" required>
